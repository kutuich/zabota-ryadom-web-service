...
Сервис не является медицинской или социальной организацией, государственным учреждением, домом престарелых, кадровым агентством или работодателем помощников. Помощники действуют как самостоятельные лица, а заказчик оплачивает работу помощнику напрямую по согласованным условиям.
...
«Забота Рядом» не является работодателем помощника, не оформляет трудовые отношения, не обещает гарантированное количество заявок и не поручает медицинские процедуры.
...
Сервис не выполняет медицинские процедуры. Нельзя публиковать и выполнять заявки на инъекции, капельницы, перевязки, лечение, диагностику, медицинский массаж, работу с катетерами, стомами и иные медицинские процедуры.
