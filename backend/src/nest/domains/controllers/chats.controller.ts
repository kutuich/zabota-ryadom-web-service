...
import { serializeAgreementContract } from "./agreementContracts.controller";
...
export class ChatsController {
  ...
  @Get("/:id/messages")
  @UseGuards(NestJwtAuthGuard)
  async getidMessages1(@Req() req: Request, @Res() res: Response) {
  ...
  @Post("/:id/messages")
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard, NestFeatureConsentGuard("send_chat_message"))
  async postidMessages2(@Req() req: Request, @Res() res: Response) {
  ...
  @UseGuards(NestJwtAuthGuard)
  async deletechatIdMessagesMessageId3(@Req() req: Request, @Res() res: Response) {
  ...
  @Patch("/:id/terms")
  @UseGuards(NestJwtAuthGuard)
  async patchidTerms4(@Req() req: Request, @Res() res: Response) {
  ...
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard, NestFeatureConsentGuard("confirm_helper"))
  async postidClientConfirm5(@Req() req: Request, @Res() res: Response) {
    const chat = await loadChatForViewer(req.params.id, req.user!);
  ...
  @Post("/:id/performer-confirm")
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard, NestFeatureConsentGuard("accept_work"))
  async postidPerformerConfirm6(@Req() req: Request, @Res() res: Response) {
    const chat = await loadChatForViewer(req.params.id, req.user!);
  ...
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard)
  async postidNotAgreed7(@Req() req: Request, @Res() res: Response) {
    const chat = await loadChatForViewer(req.params.id, req.user!);
    if (chat.clientId !== req.user!.id && chat.performerId !== req.user!.id) {
  ...
  @Post("/:id/propose-new-terms")
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard)
  async postidProposeNewTerms8(@Req() req: Request, @Res() res: Response) {
    const chat = await loadChatForViewer(req.params.id, req.user!);
    if (chat.performerId !== req.user!.id) {
