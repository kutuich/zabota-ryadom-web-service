...
export class PaymentsController {
  ...
  async getmy1(@Req() req: Request, @Res() res: Response) {
  ...
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard)
  async postidRefreshStatus2(@Req() req: Request, @Res() res: Response) {
  ...
  @Post("/mock/:id/succeed")
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard)
  async postmockIdSucceed3(@Req() req: Request, @Res() res: Response) {
  ...
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard)
  async postmockIdFail4(@Req() req: Request, @Res() res: Response) {
    ensureMockEndpointAllowed();
    const payment = await prisma.paymentTransaction.findUnique({ where: { id: req.params.id } });
    if (!payment) {
      throw new HttpError(404, "Платёж не найден", "payment_not_found");
...
export class AdminPaymentsController {
  ...
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard, NestAdminGuard)
  async postidRefund1(@Req() req: Request, @Res() res: Response) {
  ...
  @Post("/:id/manual-bank-refund")
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard, NestAdminGuard)
  async postidManualBankRefund2(@Req() req: Request, @Res() res: Response) {
  ...
  @Post("/:id/sync-tbank-status")
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard, NestAdminGuard)
  async postidSyncTbankStatus3(@Req() req: Request, @Res() res: Response) {
    res.json(await syncTbankPaymentStatus(req.params.id, req.user!.id));
  }

  @Get("/:id")
  @UseGuards(NestJwtAuthGuard, NestAdminGuard)
  async getid4(@Req() req: Request, @Res() res: Response) {
