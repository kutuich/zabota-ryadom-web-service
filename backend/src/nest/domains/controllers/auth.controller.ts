...
export class AuthController {
  @Get("/oauth/vk/start")
  async getoauthVkStart0(@Req() _req: Request, @Res() res: Response) {
    assertVkIdConfigured();
  ...
  async postoauthVkStart1(@Req() req: Request, @Res() res: Response) {
    assertVkIdConfigured();
  ...
  async getoauthVkCallback2(@Req() req: Request, @Res() res: Response) {
  ...
  @Post("/oauth/session")
  @HttpCode(200)
  async postoauthSession3(@Req() req: Request, @Res() res: Response) {
  ...
  @HttpCode(200)
  @UseGuards(NestJwtAuthGuard)
  async postoauthCompleteProfile5(@Req() req: Request, @Res() res: Response) {
