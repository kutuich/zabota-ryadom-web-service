...
export function statusTone(status: string): Tone {
  ...
  if (["new", "pending", "waiting_for_responses", "has_responses", "flagged", "in_review", "waiting_client_confirmation", "waiting_performer_confirmation", "new_terms_proposed"].includes(status)) {
    return "warning";
  }
