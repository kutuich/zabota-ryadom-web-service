...
После успешного зачисления реального платежа T-Bank или завершения реального банковского возврата backend создаёт запись во внутреннем реестре «Мой налог». Mock-платежи, бонусы, пробный баланс и ручные корректировки баланса туда не попадают. Реестр не отправляет данные в ФНС автоматически.
